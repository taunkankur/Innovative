				...
				<td width="50%">
					<div id="idArticleList" style="overflow: hidden" class="fancy elem">
						<span class="label"><div style="width: 100%; height: 100%">
								<img alt="" src="Image/trending.png" width="30px" height="30px">
								<b style="font-style: italic"><span
									style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Article...&nbsp;</span></b>
							</div></span> <br>
						<br>
						<br>
						<!-- <span
							style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Article...&nbsp;</span> -->
						<ul id="idLiArticle">
				...
				<td width="50%">
					<div id="idVideoList" style="overflow: hidden" class="fancy elem">
						<span class="label"><div style="width: 100%; height: 100%">
								<img alt="" src="Image/trending.png" width="30px" height="30px">
								<b style="font-style: italic"><span
									style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Video...&nbsp;</span></b>
							</div></span><br>
						<br>
						<br>
						<!-- <span
							style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Video...&nbsp;</span> -->
						<ul id="idLiVideo">
							<li style="list-style-type: none;"></li>
						</ul>
						<span class="endlabel"><div align="right">
				...
				<td width="50%">
					<div id="idSlidesList" style="overflow: hidden" class="fancy elem">
						<span class="label"><div style="width: 100%; height: 100%">
								<img alt="" src="Image/trending.png" width="30px" height="30px">
								<b style="font-style: italic"><span
									style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Slides...&nbsp;</span></b>
							</div></span><br>
						<br>
						<br>
						<!-- <span
							style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Slides...&nbsp;</span> -->
						<ul id="idLiSlides">
							<li style="list-style-type: none;"></li>
						</ul>
						<span class="endlabel"><div align="right">
				...
				<td width="50%">
					<div id="idBooksList" style="overflow: hidden" class="fancy elem">
						<span class="label"><div style="width: 100%; height: 100%">
								<img alt="" src="Image/trending.png" width="30px" height="30px">
								<b style="font-style: italic"><span
									style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Books...&nbsp;</span></b>
							</div></span> <br>
						<br>
						<br>
						<!-- <span
							style='color: grey; font: italic bold 30px/40px Georgia, serif;'>&nbsp;&nbsp;Books...&nbsp;</span> -->
						<ul id="content">
							<li style="list-style-type: none;"></li>
						</ul>
						<span class="endlabel"><div align="right">
